...
## Environments
- Preview: https://main--gabrielwalt-explorajourneys--aemysites.aem.page/
- Live: https://main--gabrielwalt-explorajourneys--aemysites.aem.live/
- Block Library: https://main--gabrielwalt-explorajourneys--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `gabrielwalt-explorajourneys` directory in your favorite IDE and start coding :)
